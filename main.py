...
async def main(eye_ar_thresh, eye_ar_consec_frames):
    ...
    if device_ip and device_id and device_key:
        monitor = EyeMonitor(device_id, device_key, device_ip, service_running_flag, eye_ar_thresh, eye_ar_consec_frames)
